...
URL Source: https://tour.gleam.run/everything/
...
[Hello world -----------](https://tour.gleam.run/everything/#basics-hello-world)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/hello-world "Experiment with Hello world in browser")

* * *

[Modules -------](https://tour.gleam.run/everything/#basics-modules)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/modules "Experiment with Modules in browser")

* * *

[Unqualified imports -------------------](https://tour.gleam.run/everything/#basics-unqualified-imports)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/unqualified-imports "Experiment with Unqualified imports in browser")

* * *

[Type checking -------------](https://tour.gleam.run/everything/#basics-type-checking)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/type-checking "Experiment with Type checking in browser")

* * *

[Ints ----](https://tour.gleam.run/everything/#basics-ints)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/ints "Experiment with Ints in browser")

* * *

[Floats ------](https://tour.gleam.run/everything/#basics-floats)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/floats "Experiment with Floats in browser")

* * *

[Number formats --------------](https://tour.gleam.run/everything/#basics-number-formats)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/number-formats "Experiment with Number formats in browser")

* * *

[Equality --------](https://tour.gleam.run/everything/#basics-equality)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/equality "Experiment with Equality in browser")

* * *

[Strings -------](https://tour.gleam.run/everything/#basics-strings)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/strings "Experiment with Strings in browser")

* * *

[Bools -----](https://tour.gleam.run/everything/#basics-bools)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/bools "Experiment with Bools in browser")

* * *

[Assignments -----------](https://tour.gleam.run/everything/#basics-assignments)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/assignments "Experiment with Assignments in browser")

* * *

[Discard patterns ----------------](https://tour.gleam.run/everything/#basics-discard-patterns)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/discard-patterns "Experiment with Discard patterns in browser")

* * *

[Type annotations ----------------](https://tour.gleam.run/everything/#basics-type-annotations)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/type-annotations "Experiment with Type annotations in browser")

* * *

[Type imports ------------](https://tour.gleam.run/everything/#basics-type-imports)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/type-imports "Experiment with Type imports in browser")

* * *

[Type aliases ------------](https://tour.gleam.run/everything/#basics-type-aliases)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/type-aliases "Experiment with Type aliases in browser")

* * *

[Blocks ------](https://tour.gleam.run/everything/#basics-blocks)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/blocks "Experiment with Blocks in browser")

* * *

[Lists -----](https://tour.gleam.run/everything/#basics-lists)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/lists "Experiment with Lists in browser")

* * *

[Constants ---------](https://tour.gleam.run/everything/#basics-constants)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/basics/constants "Experiment with Constants in browser")
...
[Functions ---------](https://tour.gleam.run/everything/#functions-functions)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/functions/functions "Experiment with Functions in browser")

* * *

[Higher order functions ----------------------](https://tour.gleam.run/everything/#functions-higher-order-functions)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/functions/higher-order-functions "Experiment with Higher order functions in browser")

* * *

[Anonymous functions -------------------](https://tour.gleam.run/everything/#functions-anonymous-functions)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/functions/anonymous-functions "Experiment with Anonymous functions in browser")

* * *

[Function captures -----------------](https://tour.gleam.run/everything/#functions-function-captures)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/functions/function-captures "Experiment with Function captures in browser")

* * *

[Generic functions -----------------](https://tour.gleam.run/everything/#functions-generic-functions)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/functions/generic-functions "Experiment with Generic functions in browser")

* * *

[Pipelines ---------](https://tour.gleam.run/everything/#functions-pipelines)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/functions/pipelines "Experiment with Pipelines in browser")

* * *

[Labelled arguments ------------------](https://tour.gleam.run/everything/#functions-labelled-arguments)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/functions/labelled-arguments "Experiment with Labelled arguments in browser")

* * *

[Label shorthand syntax ----------------------](https://tour.gleam.run/everything/#functions-label-shorthand-syntax)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/functions/label-shorthand-syntax "Experiment with Label shorthand syntax in browser")

* * *

* * *

[Deprecations ------------](https://tour.gleam.run/everything/#functions-deprecations)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/functions/deprecations "Experiment with Deprecations in browser")
...
[Case expressions ----------------](https://tour.gleam.run/everything/#flow-control-case-expressions)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/flow-control/case-expressions "Experiment with Case expressions in browser")

* * *

[Variable patterns -----------------](https://tour.gleam.run/everything/#flow-control-variable-patterns)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/flow-control/variable-patterns "Experiment with Variable patterns in browser")

* * *

[String patterns ---------------](https://tour.gleam.run/everything/#flow-control-string-patterns)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/flow-control/string-patterns "Experiment with String patterns in browser")

* * *

[List patterns -------------](https://tour.gleam.run/everything/#flow-control-list-patterns)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/flow-control/list-patterns "Experiment with List patterns in browser")

* * *

[Recursion ---------](https://tour.gleam.run/everything/#flow-control-recursion)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/flow-control/recursion "Experiment with Recursion in browser")
...
```
[_</>_ Run code snippet](https://tour.gleam.run/flow-control/tail-calls "Experiment with Tail calls in browser")
...
```
[_</>_ Run code snippet](https://tour.gleam.run/flow-control/list-recursion "Experiment with List recursion in browser")

* * *

[Multiple subjects -----------------](https://tour.gleam.run/everything/#flow-control-multiple-subjects)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/flow-control/multiple-subjects "Experiment with Multiple subjects in browser")

* * *

[Alternative patterns --------------------](https://tour.gleam.run/everything/#flow-control-alternative-patterns)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/flow-control/alternative-patterns "Experiment with Alternative patterns in browser")
...
```
[_</>_ Run code snippet](https://tour.gleam.run/flow-control/pattern-aliases "Experiment with Pattern aliases in browser")

* * *

[Guards ------](https://tour.gleam.run/everything/#flow-control-guards)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/flow-control/guards "Experiment with Guards in browser")
...
[Tuples ------](https://tour.gleam.run/everything/#data-types-tuples)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/data-types/tuples "Experiment with Tuples in browser")

* * *

[Custom types ------------](https://tour.gleam.run/everything/#data-types-custom-types)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/data-types/custom-types "Experiment with Custom types in browser")

* * *

[Records -------](https://tour.gleam.run/everything/#data-types-records)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/data-types/records "Experiment with Records in browser")

* * *

[Record accessors ----------------](https://tour.gleam.run/everything/#data-types-record-accessors)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/data-types/record-accessors "Experiment with Record accessors in browser")

* * *

[Record pattern matching -----------------------](https://tour.gleam.run/everything/#data-types-record-pattern-matching)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/data-types/record-pattern-matching "Experiment with Record pattern matching in browser")

* * *

[Record updates --------------](https://tour.gleam.run/everything/#data-types-record-updates)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/data-types/record-updates "Experiment with Record updates in browser")

* * *

[Generic custom types --------------------](https://tour.gleam.run/everything/#data-types-generic-custom-types)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/data-types/generic-custom-types "Experiment with Generic custom types in browser")

* * *

[Nil ---](https://tour.gleam.run/everything/#data-types-nil)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/data-types/nil "Experiment with Nil in browser")

* * *

[Results -------](https://tour.gleam.run/everything/#data-types-results)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/data-types/results "Experiment with Results in browser")

* * *

[Bit arrays ----------](https://tour.gleam.run/everything/#data-types-bit-arrays)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/data-types/bit-arrays "Experiment with Bit arrays in browser")
...
[Standard library package ------------------------](https://tour.gleam.run/everything/#standard-library-standard-library-package)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/standard-library/standard-library-package "Experiment with Standard library package in browser")

* * *

[List module -----------](https://tour.gleam.run/everything/#standard-library-list-module)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/standard-library/list-module "Experiment with List module in browser")

* * *

[Result module -------------](https://tour.gleam.run/everything/#standard-library-result-module)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/standard-library/result-module "Experiment with Result module in browser")

* * *

[Dict module -----------](https://tour.gleam.run/everything/#standard-library-dict-module)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/standard-library/dict-module "Experiment with Dict module in browser")
...
```
[_</>_ Run code snippet](https://tour.gleam.run/standard-library/option-module "Experiment with Option module in browser")
...
[Opaque types ------------](https://tour.gleam.run/everything/#advanced-features-opaque-types)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/advanced-features/opaque-types "Experiment with Opaque types in browser")

* * *

[Use ---](https://tour.gleam.run/everything/#advanced-features-use)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/advanced-features/use "Experiment with Use in browser")

* * *

[Todo ----](https://tour.gleam.run/everything/#advanced-features-todo)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/advanced-features/todo "Experiment with Todo in browser")

* * *

[Panic -----](https://tour.gleam.run/everything/#advanced-features-panic)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/advanced-features/panic "Experiment with Panic in browser")

* * *

[Let assert ----------](https://tour.gleam.run/everything/#advanced-features-let-assert)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/advanced-features/let-assert "Experiment with Let assert in browser")

* * *

[Bool assert -----------](https://tour.gleam.run/everything/#advanced-features-bool-assert)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/advanced-features/bool-assert "Experiment with Bool assert in browser")

* * *

[Externals ---------](https://tour.gleam.run/everything/#advanced-features-externals)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/advanced-features/externals "Experiment with Externals in browser")

* * *

[Multi target externals ----------------------](https://tour.gleam.run/everything/#advanced-features-multi-target-externals)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/advanced-features/multi-target-externals "Experiment with Multi target externals in browser")

* * *

[External gleam fallbacks ------------------------](https://tour.gleam.run/everything/#advanced-features-external-gleam-fallbacks)
...
```
[_</>_ Run code snippet](https://tour.gleam.run/advanced-features/external-gleam-fallbacks "Experiment with External gleam fallbacks in browser")
